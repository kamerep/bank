...
if ($_SESSION["type"] != 1) {
    ...
    echo "<h2>You are not allowed to visit this page</h2>";
    die();
}
$message = '';
...
<div class="container">
    <div class="col-sm-4 col-sm-offset-4">
        ...
        <form role="form" method="post" action="register.php">
            <p class="text-center"><span class="glyphicon glyphicon-info-sign"></span></p>
            <p class="text-center">Register A User</p>
